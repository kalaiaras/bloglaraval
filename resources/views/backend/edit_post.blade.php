...
<div class="layout-px-spacing">
  <div class="middle-content container-xxl p-0">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
        <form action="{{url('api/update_post')}}" method="POST" enctype="multipart/form-data"> 
          <div class="container bg-containter">
            ...
            <input type="hidden" name="id" value="{{$posts->id}}">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" value="{{$posts->title}}" placeholder="Enter post title">
              </div>
              <div class="form-group">
                <label for="slug">Slug (If you leave it blank, it will be generated automatically.)</label>
                <input type="text" class="form-control" name="slug" value="{{$posts->slug}}" placeholder="Enter post slug">
              </div>
              <div class="form-group">
                <label for="description">Summary & Description (Meta Tag)</label>
                <input type="text" class="form-control" name="description" value="{{$posts->description}}" placeholder="Enter meta description">
              </div>
              <div class="form-group">
                <label for="keywords">Keywords (Meta Tag)</label>
                <input type="text" class="form-control" name="keywords" value="{{$posts->keywords}}" placeholder="Enter meta keywords">
              </div>
              <div class="form-group">
        ...
        <div class="col-lg-4  ">
          <div class="form-group bg-containter">
            ...
            <input type="text" class="form-control" id="addImageUrl" name="image_url" value="{{$posts->image_url}}" placeholder="Enter image URL">
          </div>
          <div class="form-group bg-containter">
